...
Tested Software version 1.1.1 on Linux
Full results available at ucs-detect_ repository path
`data/linux-xfce4-terminal-1.1.1.yaml <https://github.com/jquast/ucs-detect/blob/master/data/linux-xfce4-terminal-1.1.1.yaml>`_
...
- python `wcwidth.wcswidth()`_ measures width {fail_record['measured_by_wcwidth']}, 
  while *Xfce4 Terminal* measures width {fail_record['measured_by_terminal']}.
...
Emoji VS-16 results for *Xfce4 Terminal* is 100 errors
