...
============  ===========  ==============  ======================================================
WIDE          36.36%       4.9%            (version_index / total_versions) × (pct_success / 100)
...
TIME          1165.28s     38.0%           1 - ((elapsed - min) / (max - min)) [inverse]
============  ===========  ==============  ======================================================
...
`U+0792 <https://codepoints.net/U+0792>`_  '\\u0792'  Lo                  1  THAANA LETTER ZAVIYANI
...
`U+1E5B <https://codepoints.net/U+1E5B>`_  '\\u1e5b'  Ll                  1  LATIN SMALL LETTER R WITH DOT BELOW
`U+0065 <https://codepoints.net/U+0065>`_  'e'        Ll                  1  LATIN SMALL LETTER E
...
DEC Mode 2       DECANM                         ANSI/VT52 Mode                                                           No           No            No
DEC Mode 3       DECCOLM                        Column Mode                                                              No           No            No
DEC Mode 4       DECSCLM                        Scrolling Mode                                                           No           No            No
DEC Mode 5       DECSCNM                        Screen Mode (light or dark screen)                                       No           No            No
DEC Mode 6       DECOM                          Origin Mode                                                              Yes          Yes           No
DEC Mode 7       DECAWM                         Auto Wrap Mode                                                           Yes          Yes           Yes
DEC Mode 8       DECARM                         Auto Repeat Mode                                                         Yes          No            Yes
DEC Mode 9       DECINLM                        Interlace Mode / Mouse X10 tracking                                      Yes          Yes           No
DEC Mode 10      DECEDM                         Editing Mode / Show toolbar (rxvt)                                       No           No            No
DEC Mode 11      DECLTM                         Line Transmit Mode                                                       No           No            No
DEC Mode 12      DECKANAM                       Katakana Shift Mode / Blinking cursor (xterm)                            Yes          Yes           No
...
DEC Mode 40      DECCRNLM                       Carriage Return/New Line Mode / Allow 80⇒132 mode (xterm)                No           No            No
...
DEC Mode 45      DECGPCS                        Graphics Print Color Syntax / Reverse-wraparound mode (xterm)            Yes          Yes           No
DEC Mode 46      DECGPBM                        Graphics Print Background Mode / Start logging (xterm)                   No           No            No
DEC Mode 47      DECGRPM                        Graphics Rotated Print Mode / Use Alternate Screen Buffer (xterm)        Yes          Yes           No
...
DEC Mode 117     DECECM                         Erase Color Mode                                                         No           No            No
...
DEC Mode 1004    FOCUS_IN_OUT_EVENTS            Send FocusIn/FocusOut events                                             Yes          Yes           No
DEC Mode 1005    MOUSE_EXTENDED_UTF8            Enable UTF-8 Mouse Mode                                                  Yes          No            No
DEC Mode 1006    MOUSE_EXTENDED_SGR             Enable SGR Mouse Mode                                                    Yes          Yes           No
DEC Mode 1007    ALT_SCROLL_XTERM               Enable Alternate Scroll Mode                                             No           No            No
...
DEC Mode 1015    MOUSE_URXVT                    Enable urxvt Mouse Mode                                                  Yes          No            No
DEC Mode 1016    MOUSE_SGR_PIXELS               Enable SGR Mouse PixelMode                                               Yes          Yes           No
...
DEC Mode 1047    ALT_SCREEN_BUFFER_XTERM        Use Alternate Screen Buffer                                              Yes          Yes           No
DEC Mode 1048    SAVE_CURSOR_DECSC              Save cursor as in DECSC                                                  Yes          Yes           Yes
...
DEC Mode 2027    GRAPHEME_CLUSTERING            Grapheme Clustering                                                      No           No            No
...
DEC Mode 9001    WIN32_INPUT_MODE               win32-input-mode                                                         No           No            No
DEC Mode 19997   KITTY_HANDLE_CTRL_C_Z          Handle Ctrl-C/Ctrl-Z mode                                                No           No            No
DEC Mode 77096   MINTTY_BIDI                    BiDi                                                                     No           No            No
DEC Mode 737769  INPUT_METHOD_EDITOR            Input Method Editor (IME) mode                                           No           No            No
===============  =============================  =======================================================================  ===========  ============  =========
