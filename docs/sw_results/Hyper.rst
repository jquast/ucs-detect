...
Tested Software version 4.0.0-canary.5 on Darwin
...
- Raw Final Score: 34.47%
  (average of all raw scores: WIDE + ZWJ + LANG + VS16 + VS15 + DEC Modes) / 6
  the categorized 'average' absolute support level of this terminal
  Note: TIME is excluded from raw average since it measures performance, not feature support

- Scaled Final Score: 47.2%
...
Emoji VS-15 results for *Hyper* are not available.
...
DEC private modes results for *Hyper* are not available.
...
The test suite completed in **4155.56 seconds** (4155s).
