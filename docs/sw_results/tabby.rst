...
Tested Software version 12.0.0 on Darwin
Full results available at ucs-detect_ repository path
`data/macos-tabby-1.0.201.yaml <https://github.com/jquast/ucs-detect/blob/master/data/macos-tabby-1.0.201.yaml>`_
...
Emoji VS-16 results for *tabby* is 100 errors
...
Pular                       455       1437       68.3368
Yaneshaʼ                      3       2536       99.8817
===================  ==========  =========  =============
...
Sequence of language *Pular* from midpoint of alignment failure records:
...
- python `wcwidth.wcswidth()`_ measures width 6, 
  while *tabby* measures width 107.
