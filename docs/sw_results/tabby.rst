...
Tested Software version 1.0.205 on Darwin
Full results available at ucs-detect_ repository path
`data/macos-tabby-1.0.205.yaml <https://github.com/jquast/ucs-detect/blob/master/data/macos-tabby-1.0.205.yaml>`_
