...
Tested Software version 0.14.6.20230701 on Linux
Full results available at ucs-detect_ repository path
`data/linux-zutty-0.14.6.20230701.yaml <https://github.com/jquast/ucs-detect/blob/master/data/linux-zutty-0.14.6.20230701.yaml>`_
...
- python `wcwidth.wcswidth()`_ measures width {fail_record['measured_by_wcwidth']}, 
  while *Zutty* measures width {fail_record['measured_by_terminal']}.
