...
Tested Software version 3.5.0 beta18 on Darwin
Full results available at ucs-detect_ repository path
`data/macos-iTerm2-3.5.0_beta18.yaml <https://github.com/jquast/ucs-detect/blob/master/data/macos-iTerm2-3.5.0_beta18.yaml>`_
